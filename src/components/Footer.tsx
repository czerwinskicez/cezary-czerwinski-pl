        ...
        <div className="grid md:grid-cols-2 gap-12">
          <div>
            ...
            <p className="text-slate-300 mb-6">
              I'm not outsourcing service, <br />
              I'm an employee. I like to participate in firm's life, values, mission, and to see the impact of my work.
            </p>
            <div className="flex space-x-4">
              {/* <a href="#" className="h-10 w-10 rounded-full bg-slate-800 flex items-center justify-center hover:bg-red-600 transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start">
                <MailIcon size={20} className="mr-3 text-red-500 mt-1 flex-shrink-0" />
                <span className="text-slate-300">czerwinskicez@gmail.com</span>
              </li>
              <li className="flex items-start">
                <MapPinIcon size={20} className="mr-3 text-red-500 mt-1 flex-shrink-0" />
